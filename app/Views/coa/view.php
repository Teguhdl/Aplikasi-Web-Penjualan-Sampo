          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="<?=base_url('coa/add')?>" class="btn btn-success btn-sm">Tambah Data coa</a>
                </div>
              </div>
              <div class="card-body">
                  ...
                  foreach($datacoa as $row):
                      ?>
                          <tr>
                            ...
                            <td>
                               <a href="<?=base_url('coa/viewData/'.$row['kode_coa'])?>" class="btn btn-primary btn-sm">Ubah</a>
                               <a onclick="deleteConfirm('<?php echo base_url('coa/delete/'.$row['kode_coa']) ?>')" href="#" class="btn btn-danger btn-sm" role="button" aria-pressed="true">Hapus</a>
