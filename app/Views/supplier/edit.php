          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <?= csrf_field() ?>
                ...
                <label for="inputEmail3" class="col-sm-2 col-form-label">Id supplier</label>
                    <div class="col-sm-2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        ?>
                      <input type="text" class="form-control" id="nama_supplier" placeholder="Nama" name="nama_supplier" value="<?=$nama_supplier?>">
